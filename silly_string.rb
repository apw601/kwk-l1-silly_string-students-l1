...
your_favorite_word = "spaghetti"

puts "My favorite word is spaghetti"

# Challenge 2: Capitalize every letter in your_favorite_word using a built in Ruby method

favorite_word_in_all_caps = "spaghetti".upcase
...
lowercased_phrase = "#{your_favorite_word}".downcase
...
puts "There are #{letter_count} characters in #{big_word}"
